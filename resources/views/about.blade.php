        ...
        <div class="container-about">
            <div class="left-content-about">
                ...
                <div class="buttons-about">
                    <button class="btn-abouts started" onclick="window.location.href='{{ route('cars') }}';">Get
                        Started</button>
                    <button class="btn-abouts contact-us"
            ...
            <div class="right-content-about">
                ...
                <div class="card-item-unique">
                    <img src="{{ url('frontend/images/copy-success.svg') }}" alt="icon" class="card-item-icon-unique">
                    <div class="card-item-text-unique">
                ...
                <div class="card-item-unique">
                    <img src="{{ url('frontend/images/heart-tick.svg') }}" alt="icon" class="card-item-icon-unique">
                    <div class="card-item-text-unique">
