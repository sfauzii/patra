        ...
        <div class="content-columns">
                ...
                <div class="card-car-details">
                    ...
                    <div class="card-rating car-details">
                        ...
                        @for ($i = 1; $i <= $fullStars; $i++) <i class="fas fa-star text-warning"></i>
                            ...
                            {{-- Bintang Kosong --}}
                            @for ($i = 1; $i <= $emptyStars; $i++) <i class="far fa-star text-secondary"></i>
                                @endfor
            ...
            <div class="column-right">
                <div class="car-informations">
                    ...
                    @if(Auth::check())
                    <!-- Button untuk booking jika user sudah login -->
                    <button class="btn-book" onclick="window.location.href='{{ route('checkout', $item->slug) }}';">
                        Proceed to Booking
                    </button>
                    @else
                    <!-- Button untuk login/register jika user belum login -->
                    <button id="login-btn" class="btn-book">
                        Register/Login
                    </button>
                    @endif
                </div>
